...
namespace config
{
    ...
    inline constexpr int BuildBarracksY = 352;
    inline constexpr int BuildInfantryY = 396;
    inline constexpr int BuildShooterY = 440;
    inline constexpr int BuildCavalryY = 484;
    inline constexpr int BuildSiegeY = 528;
    inline constexpr int BuildGuardianY = 572;
    ...
    inline constexpr int InfantryCost = 24;
    inline constexpr int ShooterCost = 26;
    inline constexpr int CavalryCost = 52;
    inline constexpr int SiegeCost = 86;
    inline constexpr int GuardianCost = 108;
    inline constexpr int InfantryHealth = 160;
    inline constexpr int ShooterHealth = 120;
    inline constexpr int CavalryHealth = 450;
    inline constexpr int SiegeHealth = 270;
    inline constexpr int GuardianHealth = 960;
    inline constexpr int InfantryDamage = 34;
    inline constexpr int ShooterDamage = 29;
    inline constexpr int CavalryDamage = 66;
    inline constexpr int SiegeDamage = 62;
    inline constexpr int GuardianDamage = 118;
