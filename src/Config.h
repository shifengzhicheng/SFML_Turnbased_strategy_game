...
namespace config
{
    ...
    inline constexpr float TechDamageBonus = 0.05f;
    inline constexpr float TechHealthBonus = 0.035f;
    inline constexpr float DrillInfantryDamageBonus = 0.20f;
    inline constexpr float DrillGuardianDamageBonus = 0.16f;
    inline constexpr float FortitudeHealthBonus = 0.20f;
    inline constexpr float VolleyDamageBonus = 0.20f;
    inline constexpr float VolleyCooldownReduction = 0.075f;
    inline constexpr float ChargeDamageBonus = 0.19f;
    inline constexpr float ChargeHealthBonus = 0.12f;
    inline constexpr float ChargeCooldownReduction = 0.055f;
    inline constexpr float SiegeDamageBonus = 0.22f;
    inline constexpr float SiegeHealthBonus = 0.12f;
    inline constexpr float SiegeBuildingDamageBonus = 0.20f;
    inline constexpr float TowerDamageBonus = 0.16f;
    inline constexpr float LogisticsTrainTimeReduction = 0.12f;
    inline constexpr float LogisticsTrainTimeFloor = 0.52f;
    inline constexpr float MiningIncomeBonus = 0.18f;
    inline constexpr float AttackCooldownFloor = 0.58f;
